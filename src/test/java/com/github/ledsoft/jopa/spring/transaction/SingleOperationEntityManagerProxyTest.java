...
public class SingleOperationEntityManagerProxyTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {"getReference", Arrays.asList(Class.class, Object.class), Arrays.asList(Person.class, new Object())},
                {"getReference", Arrays.asList(Class.class, Object.class, Descriptor.class),
                        Arrays.asList(Person.class, new Object(), new EntityDescriptor())},
